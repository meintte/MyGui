...
- Replace all occurrences of "Mygui" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `Mygui` means the name of the project, while `mygui` is used in file names.
  - Remember to rename the `include/mygui` directory to use your project's lowercase name and update all relevant `#include`s accordingly.
